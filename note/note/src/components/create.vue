<template>
  <section class="createnote">
    <div class="createnote__field">
      ...
      <input class="createnote__field--title" type="text" placeholder="标题" v-model="note.title" @keyup="setNote() | debounce 500">
      <textarea class="createnote__field--text" placeholder="Markdown" v-model="note.text" @keyup="setNote() | debounce 500"></textarea>
    </div>
  </section>
</template>
